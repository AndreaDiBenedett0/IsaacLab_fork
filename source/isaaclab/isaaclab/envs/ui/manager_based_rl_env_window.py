...
if TYPE_CHECKING:
    from ..manager_based_rl_env import ManagerBasedRLEnv, ManagerBasedPaperRLEnv
...
class ManagerBasedRLEnvPaperWindow(BaseEnvWindow):
    """Window manager for the RL environment.
    ...
    def __init__(self, env: ManagerBasedPaperRLEnv, window_name: str = "IsaacLab"):
        """Initialize the window.
