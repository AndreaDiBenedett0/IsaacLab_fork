...
@configclass
class G1FlatPPORunnerPaperCfg(G1RoughPPORunnerPaperCfg):
    def __post_init__(self):
        super().__post_init__()

        self.max_iterations = 1500
        self.experiment_name = "g1_flat_paper"
        self.policy.actor_hidden_dims = [128]
        self.policy.critic_hidden_dims = [128]